...
/**
 * - 객관식 시험 채점 시 과목별로 데이터를 저장하기 위한 Model 클래스.
 * - 객관식 시험은 과목별로 문제가 나누어져 있고 과목별 점수에 따라 과락 여부를 따져 합격의 유무를 결정해야 한다.
 * 따라서 채점이 수행될 때 각 과목에 대한 별도의 확인이 필요하기에 채점 결과 저장 및 확인에 이 Model 클래스를
 * 사용한다.
 *
 * @author BH-Ku
 * @since 2023-11-24
